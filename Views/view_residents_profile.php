  ...
  <!-- /.navbar -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= url_to('MIS::Dashboard') ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= url_to('MIS::Residents_Profile') ?>" class="nav-link active">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Resident's Profile</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active">Resident's Profile</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
